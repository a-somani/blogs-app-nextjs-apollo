...
export const ArticleImagesVar = makeVar<Record<string, string>>({})
      ...
      typePolicies: {
        ...
        Article: {
          fields: {
            imageLink: {
              read(_, { readField }) {
                const ArticleId = readField("id")
                const images = ArticleImagesVar()
                return images[ArticleId!.toString()]
              },
            },
          },
        },
